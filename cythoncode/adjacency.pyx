...
cdef class Adjacency:
    ...
    """
    def __init__(self,numpy.ndarray[numpy.float64_t, ndim=2] adjMatrix,
                 list atomNames,list unpaireds=None,list lonepairs=None,list charges=None):
    ...
    cpdef getAdjList(self):
        """
        generates an RMG compatible adjacency list
        """
        cdef str adjlistStr,newstr,name
        cdef int i,es,lp
